...
const config: Config = {
  title: 'OneForAll',
  tagline: 'Industry-grade Python GUI framework - Build desktop apps with Python and web technologies',
  favicon: 'img/oneforall-icon.svg',
          ...
          items: [
            {
              ...
              href: 'https://stackoverflow.com/questions/tagged/oneforall',
            },
            {
              label: 'Discord',
            ...
            {
              label: 'Twitter',
              href: 'https://twitter.com/oneforall',
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              label: 'PyPI',
              href: 'https://pypi.org/project/oneforall/',
            },
          ],
        },
      ],
